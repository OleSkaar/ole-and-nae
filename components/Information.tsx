        ...
        <div class="information">
            ...
            {isJapanese ? (
                <>
                    ...
                    <p>
                        ご多用の中ご参列くださり、誠にありがとうございます。
                        <br />
                        いよいよ結婚式が近づいてまいりました。
                        <br />
                        皆様に大阪でお会いできることを楽しみにしております。
                        <br />
                        当日のスケジュールなどのインフォメーションを
                        <br />
                        こちらでご案内させていただきます。
                        <br />
                        ご不明点・ご質問などございましたら、ご遠慮なくご連絡くださいませ。
                        <br />
                    </p>
                    ...
                    <p>
                        会場：大阪城西の丸庭園　大阪迎賓館
                        <br />
                        住所： 〒540-0002 大阪府 大阪市 中央区 大阪城
                        2（大阪城西の丸庭園内）
                        <br />
                        タクシーでお越しになられるお客様は乗車時にこちらのご案内をご提示ください。
                        <br />
                    ...
                    <p>
                        住所：THE LIVELY 大阪本町（ザ・ライブリー大阪本町）
                        <br />
                    ...
                    <p>
                        披露宴の後、二次会に参加してくださるお客様は迎賓館より二次会会場までシャトルバスにて送迎させていただきます。
                        <br />
                        二次会会場： Riverside Sushi Bar TOSA
                        <br />
                        住所：The BOLY OSAKA
                        <br />
                        〒541-0041大阪府大阪市中央区北浜2-1-16
                        <br />
                        THE BOLY OSAKA
                        1F大阪メトロ・京阪「淀屋橋駅」「北浜駅」より徒歩5分
                        <br />
                        京阪「なにわ橋駅」より徒歩5分
                        <br />
                    </p>
                ...
                <>
                    <h3>Location</h3>
                    <p>
                        The wedding will take place at Osaka Gehihinkan, next to
                        Osaka Castle.
                    </p>
                    <address>
            ...
            <p>
              ...
              below.
                    ...
                    <p>
                        The party will take place at the rooftop bar of The
                        Lively.
                    </p>
                    <p>
                        This will be a small get-together the night before the
                        wedding. There will be some light snacks and
                        refreshments.
                    </p>
                    <h4>Afterparty</h4>
                    <p>
                        For the guests that want to continue the party after the
                        reception. After the ceremony and dinner, around 20:00,
                        there will be a shuttle bus taking guests to{" "}
                        <a href="https://theboly.com/en/">The Boly</a>, where
                        the party will continue with drinks, food, and music.
                    </p>
                    <h3>Dress code</h3>
                    <p>Formal/cocktail attire.</p>
                    <h3>Accommodations</h3>
                    <p>
                        With the wedding taking place in central Osaka, there
                        are many options for accommodations. We recommend
                        looking for hotels or AirBnbs in the area - search for
                        Tamatsukuri.
                    </p>
                    <h3>Visa and travel information</h3>
                    <p>
                        Japan has visa-free entry for travelers from Norway,
                        U.S., the U.K., and{" "}
                    ...
                    <p>
                        As of May 8, it is no longer necessary to have a
                        vaccination certificate or a pre-departure Covid-19
                        test.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        immigration and customs forms ahead of time online. This
                        can be done at{" "}
                    ...
                    <h3>Registry</h3>
                    <p>
                        We don't have a registry or wishlist, but if you'd like
                        to give a gift we'd be very happy for a contribution to
                        our honeymoon next year.
                    </p>
                    <details>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Electronic IBAN account number:
                                        NO8312242386394
                                    </li>
                                </ul>
                            </li>
